msni_recoding <- function(df, loop) {
  ...
  #     ) >= 1 & df$b1 == 1, 1, 0
  #   )
  #   df$b1_cg <- ifelse(df$b1 == 1 & df$capacity_gap == 1, 1, 0)
  #
  #   df$b2_education <-
  #     case_when(
  ...
  #     TRUE ~ 0
  #   )
  #   df$b2_cg <- case_when(df$b2 == 1 & df$capacity_gap == 1 ~ 1,
  #                      is.na(df$b2) ~ NA_real_,
  #                      TRUE ~ 0
  #   )
  #
  ...
  #     TRUE ~ 0
  #   )
  #   df$b3_cg <- case_when(df$b3 == 1 & df$capacity_gap == 1 ~ 1,
  #                      is.na(df$b3) ~ NA_real_,
  #                      TRUE ~ 0
  #   )
  #
  ...
  #     TRUE ~ 0
  #   )
  #   df$b4_cg <- case_when(df$b4 == 1 & df$capacity_gap == 1 ~ 1,
  #                      is.na(df$b4) ~ NA_real_,
  #                      TRUE ~ 0
  #   )
  #
  ...
  #     TRUE ~ 0
  #   )
  #   df$b5_cg <- case_when(df$b5 == 1 & df$capacity_gap == 1 ~ 1,
  #                      is.na(df$b5) ~ NA_real_,
  #                      TRUE ~ 0
  #   )
  #
  ...
  #     TRUE ~ 0
  #   )
  #   df$b6_cg <- case_when(df$b6 == 1 & df$capacity_gap == 1 ~ 1,
  #                      is.na(df$b6) ~ NA_real_,
  #                      TRUE ~ 0
  #   )
  #
  ...
  #     TRUE ~ 0
  #   )
  #   df$b7_cg <- case_when(df$b7 == 1 & df$capacity_gap == 1 ~ 1,
  #                      is.na(df$b7) ~ NA_real_,
  #                      TRUE ~ 0
  #   )
