...
cluster_lookup_table <- read.csv("input/sampling_frame/combined_sample_ids.csv", 
...
lookup_table <- read.csv("input/sampling_frame/lookup_table_names.csv", stringsAsFactors = F)
